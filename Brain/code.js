...
function speakThis(message) {
    ...
    if (message.includes("tum")&&message.includes("kahan")||message.includes("kya")&&message.includes("hal")&&message.includes("hai")){
        ansQuery("I am all good and wishing same for you.")
    }
    
    
    if(!message.includes("change")&&message.includes("my")&&message.includes("name")||message.includes("myself")){
        if(userName == null){
    ...
    else if(message.includes("open")&&message.includes("twitter"))
    {
        window.open('https://www.twitter.com');
        ansQuery("Opening Whatsapp")
    }
    else if(message.includes("open")&&message.includes("wikipedia"))
    {
        window.open('https://www.wikipedia.org/');
        ansQuery("Opening Whatsapp")
    }
    else if(message.includes("open")&&message.includes("linkedin")||message.includes("open")&&message.includes("linked")&&message.includes("in"))
    {
    ...
    else if(!message.includes("open")&&!message.includes("you")&&!message.includes("hello")&&!message.includes("your")&&!message.includes("you")&&!message.includes("my")&&!message.includes("introduce yourself")&&!message.includes("what")&&!message.includes("who")&&!message.includes("why")&&!message.includes("how")&&!message.includes("search")&&!message.includes("name")&&!message.includes("tum")&&!message.includes("tumhara")&&!message.includes("chalao")&&!message.includes("kholo")){
        var updatedQuery = message.replace("", "+")
            updatedQuery = message.replace("search", "")
            window.open(`https://www.google.com/search?q=${updatedQuery}`, "_blank");
